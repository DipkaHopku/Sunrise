...
int main(void) {
	...
	glDisable(GL_DEPTH_TEST); //нужен только для 3д
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT | GL_STENCIL_BUFFER_BIT); //при очистке глубины рисует чёрный экран. почему?
